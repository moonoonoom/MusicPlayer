...
export default {
    ...
    methods:{
      ...
      getList(){
        this.$axios
            .get(`/workOrder/allWorkOrder/${this.pageNo}/${this.pageSize}`)
            .then(response =>{
      ...
      delALL(){
           this.$axios
            .post(`/workOrder/deletes`,this.multipleSelection)
            .then(response =>{
              // console.log(response);
              if(response.data.msg=="删除成功"){
                this.getList();
